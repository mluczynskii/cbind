...
def main():
    ...
    parser.add_argument('c_output_file')
    parser.add_argument('lua_output_file')
    ...
    with open(args.c_output_file, 'w') as output:
    ...
    if luaFunctionHandler.needWrappers():
        with open(args.lua_output_file, 'w') as luaOutput:
